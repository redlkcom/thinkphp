<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\webserver\PHPTutorial\WWW\tp5\public/../app/wp\view\Address\add.html";i:1562573535;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--loading页开始-->
<input type="hidden" id="url" value="<?php echo url('Address/ajax'); ?>">
<div class="loading">
	<div class="loader">
