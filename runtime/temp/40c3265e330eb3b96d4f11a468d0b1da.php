<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"E:\webserver\PHPTutorial\WWW\tp5\public/../app/admin\view\Product\index.html";i:1560323390;s:66:"E:\webserver\PHPTutorial\WWW\tp5\app\admin\view\Public\header.html";i:1560420240;s:66:"E:\webserver\PHPTutorial\WWW\tp5\app\admin\view\Public\footer.html";i:1560075502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<a href="<?php echo url('Product/add'); ?>" class="layui-btn">
...
<table class="layui-table">
  ...
  <tbody>
    <?php if(is_array($list_copy) || $list_copy instanceof \think\Collection || $list_copy instanceof \think\Paginator): $i = 0; $__LIST__ = $list_copy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <tr>
      ...
      <td>
        <?php if(($vo['thumb'][0]=='')): ?>
        <img src="/public/Uploads/timg.jpg" width="50" height="50">
        <?php else: ?><img src="/public/Uploads/<?php echo $vo['thumb']['0']; ?>" width="50" height="50">
        <?php endif; ?>
      </td>
      <td><?php echo $vo['time']; ?></td>
      <td><?php echo $vo['price']; ?></td>
      <td><?php echo $vo['count']; ?></td>
      <td><a href="<?php echo url('Product/update',['id'=>$vo['id']]); ?>" class="layui-btn">修改</a>
        <a href="javascript:void(0)" class="layui-btn layui-btn-danger del" url="<?php echo url('Product/luo_del',['id'=>$vo['id']]); ?>">删除</a>
        </td>
    </tr>
