<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\webserver\PHPTutorial\WWW\tp5\public/../app/home\view\User\reg.html";i:1561433015;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
...
<body>
    ...
    <div class="middle">
        <div class="container clear">
                    ...
                    <li class="on">
                        ...
                        <div class="protocol">
                            <label >
                                ...
                                <span>我已阅读并同意<a href="">《蓝水晶商城协议》</a></span>
                            </label>
                        </div>
            ...
            <div class="right fl">
                <p>我已有蓝水晶账号</p>
                <p>现在就<a href="<?php echo url('User/login'); ?>">立即登录</a></p>
            </div>
        </div>
