<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"E:\webserver\PHPTutorial\WWW\tp5\public/../app/home\view\cart\confirm.html";i:1561538745;s:65:"E:\webserver\PHPTutorial\WWW\tp5\app\home\view\Public\header.html";i:1562287717;s:65:"E:\webserver\PHPTutorial\WWW\tp5\app\home\view\Public\footer.html";i:1560819925;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
                ...
                <table>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="3">
                                <form action="<?php echo url('Address/index'); ?>" style="width: 324px;" method="post">
                                    
                                <span>共计 <em class="totalCount"><?php echo \think\Session::get('num'); ?></em> 件商品</span>
                                <span>总价：<em class="totalPrice"><?php echo \think\Session::get('sumtotal'); ?></em></span>
                                <button class="btn" id="confirmOrder" type="">确认订单</button>
                                </form>
                            </th>
                        </tr>
                    </tfoot>
