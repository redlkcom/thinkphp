...
class Index extends Base
{
    public function index()
    {
        ...
        $xin=db('product',[],false)->alias('a')->field('a.id,a.name,pid,img,count,price,des,content,b.name p_name')->join('pro_category b','a.category=b.id')->where(['a.is_del'=>0,'pid'=>1])->paginate(12);
      ...
      foreach ($list_copy['data'] as $key => $value) {
        ...
        $this->assign(['ban_list'=>$ban_list,'list_copy'=>$list_copy]);
